...
<h3> Your Profile is Public: 
<cfset isPublic = session?.ispublic ?: false >
#yesnoformat(ispublic)#
<a href="profileswitch.cfm?switch=#booleanFormat(!ispublic)#&token=#csrfgeneratetoken()#">switch privacy</a>
</h3>
</cfoutput> 
